...
## Evidência
- `evidencias/sessao-logout/logout-por-inatividade-epic-sadface.png`
- `evidencias/sessao-logout/logout-inatividade-repeticao-1.png`
- `evidencias/sessao-logout/logout-inatividade-repeticao-2.png`
- `evidencias/sessao-logout/carrinho-antes-do-teste-inatividade.png` (mostra o carrinho com itens antes do teste, para comparação com a persistência pós-logout)
