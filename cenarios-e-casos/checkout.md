...
**Obtido:** 
**Obtido:** conforme o esperado (evidência: ![Evidência: caso1 overview sucesso](../evidencias/checkout/caso1-overview-sucesso.png), [Ver comprovante em PDF](../evidencias/checkout/caso1-comprovante.pdf)).
...
**Obtido:** s
**Obtido:** sistema finaliza a compra e gera comprovante de R$0,00 (evidência: ![Evidência: caso3 overview valor zero](../evidencias/checkout/caso3-overview-valor-zero.png), [Ver comprovante em PDF](../evidencias/checkout/caso3-comprovante-valor-zero.pdf)).
